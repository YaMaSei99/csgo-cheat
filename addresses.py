...
dwGameDir = 0x62A900;
dwGameRulesProxy = 0x52F414C;
dwGetAllClasses = 0xDE4CEC;
dwGlobalVars = 0x58BCE0;
dwGlowObjectManager = 0x531F608;
dwInput = 0x5227FB0;
dwInterfaceLinkList = 0x96B264;
dwLocalPlayer = 0xDBA5BC;
dwMouseEnable = 0xDC02C8;
dwMouseEnablePtr = 0xDC0298;
dwPlayerResource = 0x3205240;
dwRadarBase = 0x520B754;
dwSensitivity = 0xDC0164;
dwSensitivityPtr = 0xDC0138;
dwSetClanTag = 0x8A320;
dwViewMatrix = 0x4DC82F4;
dwWeaponTable = 0x5228A74;
dwWeaponTableIndex = 0x326C;
dwYawPtr = 0xDBFF28;
dwZoomSensitivityRatioPtr = 0xDC6660;
dwbSendPackets = 0xD81A2;
dwppDirect3DDevice9 = 0xA5050;
find_hud_element = 0x26BB55B0;
force_update_spectator_glow = 0x3BCCEA;
interface_engine_cvar = 0x3E9EC;
is_c4_owner = 0x3C9D70;
m_bDormant = 0xED;
m_flSpawnTime = 0x103C0;
m_pStudioHdr = 0x2950;
m_pitchClassPtr = 0x520B9F0;
m_yawClassPtr = 0xDBFF28;
