...
dwForceAttack = 0x3207FDC;
dwForceAttack2 = 0x3207FE8;
dwForceBackward = 0x3208024;
dwForceForward = 0x3208018;
dwForceJump = 0x5281A64;
dwForceLeft = 0x3208030;
dwForceRight = 0x320803C;
dwGameDir = 0x62A900;
dwGameRulesProxy = 0x52F528C;
dwGetAllClasses = 0xDE5DAC;
dwGlobalVars = 0x58BCE0;
dwGlowObjectManager = 0x5320758;
dwInput = 0x52290F0;
dwInterfaceLinkList = 0x96BD44;
dwLocalPlayer = 0xDBB5CC;
dwMouseEnable = 0xDC12D8;
dwMouseEnablePtr = 0xDC12A8;
dwPlayerResource = 0x3206380;
dwRadarBase = 0x520C894;
dwSensitivity = 0xDC1174;
dwSensitivityPtr = 0xDC1148;
dwSetClanTag = 0x8A320;
dwViewMatrix = 0x4DC9434;
dwWeaponTable = 0x5229BB4;
dwWeaponTableIndex = 0x326C;
dwYawPtr = 0xDC0F38;
dwZoomSensitivityRatioPtr = 0xDC7720;
dwbSendPackets = 0xD81F2;
dwppDirect3DDevice9 = 0xA5050;
find_hud_element = 0x266555B0;
