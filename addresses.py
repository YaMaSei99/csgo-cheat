...
dwEntityList = 0x4DD0E6C;
dwForceAttack = 0x3201380;
dwForceAttack2 = 0x320138C;
dwForceBackward = 0x320132C;
dwForceForward = 0x32013B0;
dwForceJump = 0x527AD90;
dwForceLeft = 0x3201338;
dwForceRight = 0x3201344;
dwGameDir = 0x62A880;
dwGameRulesProxy = 0x52EDDEC;
dwGetAllClasses = 0xDDF17C;
dwGlobalVars = 0x58BCC8;
dwGlowObjectManager = 0x5319260;
dwInput = 0x5222440;
dwInterfaceLinkList = 0x967FB4;
dwLocalPlayer = 0xDB55DC;
dwMouseEnable = 0xDBB2E8;
dwMouseEnablePtr = 0xDBB2B8;
dwPlayerResource = 0x31FF6D0;
dwRadarBase = 0x5205BE4;
dwSensitivity = 0xDBB184;
dwSensitivityPtr = 0xDBB158;
dwSetClanTag = 0x8A340;
dwViewMatrix = 0x4DC2784;
dwWeaponTable = 0x5222F08;
dwWeaponTableIndex = 0x326C;
dwYawPtr = 0xDBAF48;
dwZoomSensitivityRatioPtr = 0xDC1158;
dwbSendPackets = 0xD94C2;
dwppDirect3DDevice9 = 0xA5050;
find_hud_element = 0x28B249F0;
